...
NATS Agent Protocol; the wire spec at [`docs/nats-agent-protocol.md`](docs/nats-agent-protocol.md)
...
The full check sequence before pushing:
...
If you find the implementation contradicts `docs/nats-agent-protocol.md`,
...
[`nats-ai-docs`](https://github.com/synadia-ai/nats-agent-sdk-docs) repo first;
the SDK follows the spec.
