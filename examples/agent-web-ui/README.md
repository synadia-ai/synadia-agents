...
- **Unified agent grid** — every discovered agent, controller, and session shows up as a card in a single grouped grid (PI Headless Sessions · PI Headless · Claude Code Headless Sessions · Claude Code Headless · Claude Code · Codex · Hermes · Open Agent · OpenCode · OpenClaw · PI Interactive · Other). No mode switching.
